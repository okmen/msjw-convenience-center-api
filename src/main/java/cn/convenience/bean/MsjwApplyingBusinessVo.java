 ...
 *
 */
public class MsjwApplyingBusinessVo implements Serializable {
...
*/	private String applyingUrlWx;//	微信在办跳转地址，listStatus设置为02时必传
	...
	public String toString() {
		return "MsjwApplyingBusinessVo [tylsbh=" + tylsbh + ", applyman=" + applyman + ", eventname=" + eventname
				+ ", showstatus=" + showstatus + ", insdate=" + insdate + ", lastupddate=" + lastupddate
				+ ", liststatus=" + liststatus + ", applyingUrlWx=" + applyingUrlWx + ", jinduUrlWx=" + jinduUrlWx
				+ ", openid=" + openid + ", showtype=" + showtype + ", source=" + source + "]";
	}
